...
MAP_INSTRUCTIONS = (
    ...
    "  4. If auth is required, log in first (check SCOPE for credentials)\n"
    "\n"
    "PART B - MAP THE SITE:\n"
    ...
    "\n"
    "PART C - CROSS-REFERENCE WITH CODE:\n"
    "  Using the ENTITY MODEL from UNDERSTAND:\n"
    "  1. Compare visible routes with ALL routes found in code\n"
    ...
    "  4. Note routes in code not reachable from navigation\n"
...
INSPECT_INSTRUCTIONS = (
    "INSPECT pages from the navigation map and action inventory.\n"
    "\n"
    "ITERATION {iteration} of {max_iter}\n"
    "\n"
    "This is NOT a quick visual scan. This is a SYSTEMATIC AUDIT.\n"
    "You are testing this site like a QA engineer, not just looking at it.\n"
    "\n"
    "═══════════════════════════════════════════════\n"
    "PHASE 1: PAGE-LEVEL INSPECTION\n"
    "═══════════════════════════════════════════════\n"
    "\n"
    ...
    "    2. Wait for full load (spinners, skeletons must resolve)\n"
    "    3. Screenshot the fully loaded page\n"
    "    4. Scroll the FULL page length -- screenshot bottom too\n"
    "    5. Note: Does data load automatically? Or does it require action?\n"
    "\n"
    "  STEP 2 - CLASSIFY THE PAGE TYPE:\n"
    "    Determine what type of page this is: Dashboard, List/Table,\n"
    "    Detail/View, Form, Settings, Auth, or Other.\n"
    "    Then check it against the SaaS page standards:\n"
    "\n"
    + SAAS_PAGE_STANDARDS + "\n"
    "\n"
    "    For EACH standard feature listed for this page type:\n"
    "      - Is it present? -> Move on\n"
    "      - Is it absent? -> Record as MISSING FUNCTIONALITY\n"
    "      - Is it present but broken? -> Record as BUG\n"
    "      - Is it present but poorly implemented? -> Record as UI/UX\n"
    "\n"
    "  STEP 3 - AUDIT EVERY UI ELEMENT:\n"
    "    Systematically examine every visible element on the page:\n"
    "    - Buttons: Do they have text/labels? Do they do something on click?\n"
    "    - Tables: Do they have data? If empty, is there an empty state message?\n"
    "    - Cards: Do clickable-looking cards actually navigate somewhere?\n"
    "    - Icons: Do they have tooltips? Are they meaningful?\n"
    "    - Links: Do they go somewhere? Is the destination correct?\n"
    "    - Forms: Do fields have labels? Are required fields marked?\n"
    "    - Images: Do they load? Are they sized correctly?\n"
    "    - Disabled elements: Is there a reason visible to the user?\n"
    "    Record every orphaned, broken, or meaningless element.\n"
    "\n"
    "  STEP 4 - CHECK ALL ISSUE CATEGORIES:\n"
    "\n"
    + ISSUE_CATEGORIES + "\n"
    "\n"
    "  STEP 5 - CHECK CONSOLE AND NETWORK:\n"
    "    - Check browser console for JavaScript errors\n"
    "    - Note any failed API calls visible in network tab\n"
    ...
    "\n"
    "═══════════════════════════════════════════════\n"
    "PHASE 3: API-UI CROSS-REFERENCE\n"
    "═══════════════════════════════════════════════\n"
    "\n"
    + API_UI_CROSS_REFERENCE + "\n"
    "\n"
    "═══════════════════════════════════════════════\n"
    "PHASE 4: INDUSTRY STANDARD COMPARISON\n"
    "═══════════════════════════════════════════════\n"
    "\n"
    "For pages or features that seem incomplete:\n"
    "  1. Use WebSearch to find examples of similar pages in well-known\n"
    "     SaaS applications (e.g., 'best practices for SaaS user\n"
    "     management page', 'standard features for admin dashboard')\n"
    "  2. Compare what you found in the browser with industry standards\n"
    "  3. Record MISSING FUNCTIONALITY for significant gaps\n"
    "  4. Only flag genuinely useful missing features, not nice-to-haves\n"
    ...
    "    The ASSESS step will filter false positives later.\n"
    "  - Take screenshots BEFORE and AFTER interactions.\n"
    "  - If a page has multiple states (tabs, modals, dropdowns), check EACH.\n"
    "  - Test with different data: empty, minimal, maximal, special characters.\n"
    "  - Every entity in the entity model MUST be CRUD-tested.\n"
    "  - Every page in the site map MUST be visited and audited.\n"
    "\n"
    "COVERAGE TRACKING:\n"
    "  After this iteration, report:\n"
    "  ```\n"
    "  COVERAGE STATUS:\n"
    "    Pages inspected: [list] ([N] of [total])\n"
    "    Pages remaining: [list]\n"
    "    Entities CRUD-tested: [list] ([N] of [total])\n"
    "    Entities remaining: [list]\n"
    "    Negative paths tested: [list]\n"
    "    Findings this iteration: [N]\n"
    "    Total findings so far: [N]\n"
    "  ```\n"
    "\n"
    "CONFIDENCE ASSESSMENT:\n"
    "  - CERTAIN: All pages inspected, all entities CRUD-tested,\n"
    "    negative paths tested, API-UI cross-reference done\n"
    "  - HIGH: 80%+ pages, most entities CRUD-tested, some negative paths\n"
    "  - MEDIUM: 50-80% pages, some entities CRUD-tested\n"
    "  - LOW: Under 50% pages inspected\n"
    "  - EXPLORING: Just starting inspection\n"
    "\n"
    "IMPORTANT: Do NOT report CERTAIN until you have:\n"
    "  1. Visited EVERY page in the site map\n"
    "  2. CRUD-tested EVERY entity in the entity model\n"
    "  3. Tested at least 3 negative paths (invalid URLs, invalid data)\n"
    "  4. Compared at least 2 page types against SaaS standards\n"
    "  5. Cross-referenced API endpoints against UI actions\n"
    "\n"
    "ADVANCE:\n"
