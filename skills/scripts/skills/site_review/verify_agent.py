...
PARSE_INSTRUCTIONS = (
    ...
    "\n"
    "Your focus group was specified in your launching prompt. The findings file\n"
    "path (under .site-review/) is in shared context.\n"
    "\n"
    "ACTIONS:\n"
    "  1. Read the findings file (.site-review/findings.md) from the run ledger dir\n"
    "  2. Identify OPEN findings matching your assigned category group\n"
...
VERIFY_INSTRUCTIONS = (
    ...
    "\n"
    "Cross-reference against the behaviour oracle (the entity/endpoint/role model\n"
    "in shared context): a behaviour that does not crash can still be CONFIRMED\n"
    "wrong if it contradicts the model (wrong enum, wrong audience, missing authz).\n"
    "\n"
    "CONFIRMED:\n"
    "  - The code supports the observation (or contradicts the oracle)\n"
    "  - The issue is genuine and fixable\n"
    "  - Note the specific code responsible (file:line) and a fix hint\n"
    "\n"
    "DESIGN_CHOICE:\n"
