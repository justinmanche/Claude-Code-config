...
WORK_PHASES: dict[str, dict] = {
    "plan-design": {
        "execute": "skills.planner_old.architect.plan_design_execute",
        "qr_fix": "skills.planner_old.architect.plan_design_qr_fix",
        "qr_phase": "plan-design",
    },
    "plan-code": {
        "execute": "skills.planner_old.developer.plan_code_execute",
        "qr_fix": "skills.planner_old.developer.plan_code_qr_fix",
        "qr_phase": "plan-code",
    },
    "plan-docs": {
        "execute": "skills.planner_old.technical_writer.plan_docs_execute",
        "qr_fix": "skills.planner_old.technical_writer.plan_docs_qr_fix",
        "qr_phase": "plan-docs",
    },
    "impl-code": {
        "execute": "skills.planner_old.developer.exec_implement_execute",
        "qr_fix": "skills.planner_old.developer.exec_implement_qr_fix",
        "qr_phase": "impl-code",
    },
    "impl-docs": {
        "execute": "skills.planner_old.technical_writer.exec_docs_execute",
        "qr_fix": "skills.planner_old.technical_writer.exec_docs_qr_fix",
        "qr_phase": "impl-docs",
    },
}
