...
class PlannerResourceProvider:
    ...
    def get_resource(self, name: str) -> str:
        ...
        """
        resource_path = Path(__file__).resolve().parents[4] / "planner-old" / "resources" / name
        try:
