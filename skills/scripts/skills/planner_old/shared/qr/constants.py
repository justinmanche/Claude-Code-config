...
QR_ROUTING = {
    ("planner", "plan-design"): (6, "skills.planner_old.orchestrator.planner", 14),
    ("planner", "plan-code"): (10, "skills.planner_old.orchestrator.planner", 14),
    ("planner", "plan-docs"): (14, "skills.planner_old.orchestrator.planner", 14),
    ("executor", "impl-code"): (5, "skills.planner_old.orchestrator.executor", 10),
    ("executor", "impl-docs"): (9, "skills.planner_old.orchestrator.executor", 10),
}
