...
QR_PHASES: dict[str, dict] = {
    "plan-design": {
        ...
        "route_step": 6,
        "artifact": "plan.json",
        "decompose_script": "skills.planner_old.quality_reviewer.plan_design_qr_decompose",
        "verify_script": "skills.planner_old.quality_reviewer.plan_design_qr_verify",
        "decompose_steps": 13,
        "verify_steps": 3,
    },
    "plan-code": {
        ...
        "route_step": 10,
        "artifact": "plan.json",
        "decompose_script": "skills.planner_old.quality_reviewer.plan_code_qr_decompose",
        "verify_script": "skills.planner_old.quality_reviewer.plan_code_qr_verify",
        "decompose_steps": 13,
        "verify_steps": 3,
    },
    "plan-docs": {
        ...
        "route_step": 14,
        "artifact": "plan.json",
        "decompose_script": "skills.planner_old.quality_reviewer.plan_docs_qr_decompose",
        "verify_script": "skills.planner_old.quality_reviewer.plan_docs_qr_verify",
        "decompose_steps": 13,
        "verify_steps": 3,
    },
    "impl-code": {
        ...
        "route_step": 5,
        "artifact": "plan.json",
        "decompose_script": "skills.planner_old.quality_reviewer.impl_code_qr_decompose",
        "verify_script": "skills.planner_old.quality_reviewer.impl_code_qr_verify",
        "decompose_steps": 13,
        "verify_steps": 3,
    },
    "impl-docs": {
        ...
        "route_step": 9,
        "artifact": "plan.json",
        "decompose_script": "skills.planner_old.quality_reviewer.impl_docs_qr_decompose",
        "verify_script": "skills.planner_old.quality_reviewer.impl_docs_qr_verify",
        "decompose_steps": 13,
        "verify_steps": 3,
    },
}
...
def get_orchestrator_module(phase: str) -> str:
    ...
    return f"skills.planner_old.orchestrator.{workflow}"
...
def get_route_step_info(phase: str) -> tuple[int, str, int]:
    ...
    config = get_phase_config(phase)
    workflow = config["workflow"]
    module_path = f"skills.planner_old.orchestrator.{workflow}"
