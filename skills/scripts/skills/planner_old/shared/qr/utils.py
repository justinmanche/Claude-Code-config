...
from skills.planner_old.shared.qr.constants import QR_ROUTING
from skills.planner_old.shared.schema import QA_ITEM_DEFAULTS
...
def by_blocking_severity(iteration: int) -> ItemPredicate:
    ...
    """
    from skills.planner_old.shared.qr.constants import get_blocking_severities
