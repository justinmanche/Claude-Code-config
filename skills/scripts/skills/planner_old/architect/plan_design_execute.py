...
def get_step_guidance(
    ...
    MODULE_PATH = module_path or "skills.planner_old.architect.plan_design_execute"
    ...
    if step == 1:
        ...
        return {
            ...
            "actions": [
                ...
                "",
                "  python3 -m skills.planner_old.cli.plan --state-dir $STATE_DIR <command>",
                "",
                "  Commands:",
                ...
                "",
                "1. Create diagram:",
                "   python3 -m skills.planner_old.cli.plan --state-dir $STATE_DIR set-diagram \\",
                "     --type architecture --scope overview --title 'System Overview'",
                "",
                "2. Add nodes (3-7 recommended, prevents visual overload):",
                "   python3 -m skills.planner_old.cli.plan --state-dir $STATE_DIR add-diagram-node \\",
                ...
                "   python3 -m skills.planner_old.cli.plan --state-dir $STATE_DIR add-diagram-edge \\",
                ...
                "  python3 -m skills.planner_old.cli.plan validate --phase plan-design",
                "",
                "REFERENCE SCHEMA:",
                "",
                plan_json_schema,
