...
def get_step_guidance(
    ...
    MODULE_PATH = module_path or "skills.planner_old.architect.plan_design_qr_fix"
    ...
    if step == 1:
        ...
        return {
            ...
            "actions": [
                ...
                "  python3 -m skills.planner_old.cli.plan --state-dir $STATE_DIR set-decision \\",
        ...
        return {
            ...
            "actions": [
                ...
                "  python3 -m skills.planner_old.cli.plan validate --phase plan-design --state-dir {state_dir}",
                "",
