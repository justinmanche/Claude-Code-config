...
def get_step_guidance(
    ...
    MODULE_PATH = module_path or "skills.planner_old.developer.plan_code_execute"
    ...
    if step == 1:
        ...
        return {
            ...
            "actions": [
                ...
                "  python3 -m skills.planner_old.cli.plan --state-dir $STATE_DIR list-milestones",
                "  python3 -m skills.planner_old.cli.plan --state-dir $STATE_DIR list-intents M-001",
                "  python3 -m skills.planner_old.cli.plan --state-dir $STATE_DIR set-change \\",
        ...
        return {
            ...
            "actions": [
                ...
                "  2. Bash tool: python3 -m skills.planner_old.cli.plan set-change ... --diff $'...'",
                "",
        ...
        return {
            ...
            "actions": [
                ...
                "",
                "  python3 -m skills.planner_old.cli.plan validate --phase plan-code",
                "",
                "This validates:",
