...
def get_step_guidance(
    ...
    MODULE_PATH = module_path or "skills.planner_old.developer.plan_code_qr_fix"
    ...
    if step == 1:
        ...
        return {
            ...
            "actions": [
                ...
                f"  python3 -m skills.planner_old.cli.plan validate --phase plan-code --state-dir {state_dir}",
                "",
