...
from skills.planner_old.shared.routing import route_work_phase
from skills.planner_old.shared.resources import STATE_DIR_ARG_REQUIRED
from skills.planner_old.shared.qr.utils import has_qr_failures, get_qr_iteration
...
def get_step_guidance(
    ...
    if has_qr_failures(state_dir, PHASE_KEY):
        ...
        target = "skills.planner_old.technical_writer.plan_docs_qr_fix"
        return {
