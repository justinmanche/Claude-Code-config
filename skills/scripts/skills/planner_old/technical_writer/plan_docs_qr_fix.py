...
from skills.planner_old.shared.resources import validate_state_dir_requirement, get_context_path, render_context_file
...
def get_step_guidance(
    ...
    MODULE_PATH = module_path or "skills.planner_old.technical_writer.plan_docs_qr_fix"
