...
from skills.planner_old.quality_reviewer.prompts.decompose import dispatch_step
...
def get_step_guidance(step: int, module_path: str = None, **kwargs) -> dict:
    module_path = module_path or "skills.planner_old.quality_reviewer.plan_design_qr_decompose"
