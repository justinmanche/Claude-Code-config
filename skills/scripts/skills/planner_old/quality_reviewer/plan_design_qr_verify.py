...
from skills.planner_old.shared.schema import get_qa_state_schema_example
...
def get_step_guidance(step: int, module_path: str = None, **kwargs) -> dict:
    ...
    module_path = module_path or "skills.planner_old.quality_reviewer.plan_design_qr_verify"
