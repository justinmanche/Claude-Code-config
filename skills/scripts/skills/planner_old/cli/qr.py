...
Usage: python3 -m skills.planner_old.cli.qr --state-dir <dir> --qr-phase <phase> <command> [args]
...
def cli(args: list[str] = None):
    ...
    if not args:
        print("Usage: python3 -m skills.planner_old.cli.qr --state-dir <dir> --qr-phase <phase> <command> [args]")
        print("")
